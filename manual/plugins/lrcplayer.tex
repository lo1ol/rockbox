...
Press \ActionRCWpsBrowse on a line to change its time to the current position of the track.
To set a specific time or to adjust the time, press \ActionStdContext{} to
bring up a screen to adjust the time.
When you change line's time, you also change time of lines, that go after it.
